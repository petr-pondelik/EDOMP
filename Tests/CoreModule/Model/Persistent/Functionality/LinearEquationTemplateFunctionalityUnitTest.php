...
use App\Tests\MockTraits\Repository\LinearEquationTemplateRepositoryMock;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\ORM\EntityNotFoundException;
use Nette\Utils\DateTime;

/**
 * Class LinearEquationTemplateFunctionalityUnitTest
 * @package App\Tests\CoreModule\Model\Persistent\Functionality
 */
final class LinearEquationTemplateFunctionalityUnitTest extends ProblemFunctionalityUnitTestCase
{
    use LinearEquationTemplateRepositoryMock;

    /**
     * @var LinearEquationTemplateFunctionality
     */
    ...
    {
        parent::setUp();
        $this->setUpLinearEquationTemplateRepositoryMock();

        $templateJsonDataFunctionalityMock = $this->getMockBuilder(TemplateJsonDataFunctionality::class)
                                                ->disableOriginalConstructor()
                                                ->getMock();

        $this->functionality = new LinearEquationTemplateFunctionality(
            $this->em, $this->userRepositoryMock, $this->linearEquationTemplateRepositoryMock,
    ...
    public function testCreate(): void
    {
        ...
        $expected = new LinearEquationTemplate();
    ...
    public function testUpdate(): void
    {
        ...
        /** @var LinearEquationTemplate $expected */
        $expected = $this->linearEquationTemplateRepositoryMock->find(1);
        $expected->setVariable($data['variable']);
        $expected->setBody($data['body']);
        $expected->setTextBefore($data['textBefore']);
        $expected->setTextAfter($data['textAfter']);
