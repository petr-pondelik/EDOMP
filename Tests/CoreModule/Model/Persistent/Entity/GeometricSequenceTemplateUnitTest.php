...
/**
 * Class GeometricSequenceTemplateUnitTest
 * @package App\Tests\CoreModule\Model\Persistent\Entity
 */
final class GeometricSequenceTemplateUnitTest extends PersistentEntityTestCase
{
    ...
    public function testValidState(): void
    {
        ...
        $this->assertInstanceOf(GeometricSequenceTemplate::class, $entity);
