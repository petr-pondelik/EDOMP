    ...
    public function render(): void
    {
        ...
        if ($this->edit){
            switch ($this->templateType){
                case $this->constHelper::LINEAR_EQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/linearEqEdit.latte');
                                                    break;
                case $this->constHelper::QUADRATIC_EQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/quadraticEqEdit.latte');
                                                        break;
                case $this->constHelper::ARITHMETIC_SEQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/arithmeticSeqEdit.latte');
                                                            break;
                case $this->constHelper::GEOMETRIC_SEQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/geometricSeqEdit.latte');
                                                        break;
            }
        }
        else{
            switch ($this->templateType){
                case $this->constHelper::LINEAR_EQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/linearEqCreate.latte');
                                                    break;
                case $this->constHelper::QUADRATIC_EQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/quadraticEqCreate.latte');
                                                        break;
                case $this->constHelper::ARITHMETIC_SEQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/arithmeticSeqCreate.latte');
                                                            break;
                case $this->constHelper::GEOMETRIC_SEQ: $this->template->render(__DIR__ . DIRECTORY_SEPARATOR . 'template/geometricSeqCreate.latte');
                                                        break;
            }
        }
    }
