...
use Ublaboo\Responses\ImageResponse;
...
class TestPresenter extends AdminPresenter
{
    ...
    (
        ProblemManager $problemManager, LogoManager $logoManager, TestManager $testManager,
    ...
    {
        $this->template->logos = $this->logoManager->getAll('DESC');
    }
