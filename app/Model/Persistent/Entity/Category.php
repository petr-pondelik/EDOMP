...
class Category extends BaseEntity
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Model\Persistent\Entity\SubCategory", mappedBy="category", cascade={"all"})
     */
    protected $subCategories;

    /**
     * @ORM\ManyToMany(targetEntity="App\Model\Persistent\Entity\Group", mappedBy="categories", cascade={"persist", "merge"})
     */
    protected $groups;

    /**
     * @ORM\ManyToMany(targetEntity="App\Model\Persistent\Entity\SuperGroup", mappedBy="categories", cascade={"persist", "merge"})
     */
