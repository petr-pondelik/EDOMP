...
/**
 * @ORM\Entity(repositoryClass="App\Model\Persistent\Repository\ProblemTypeRepository")
 *
 * Class ProblemType
...
class ProblemType extends BaseEntity
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Model\Persistent\Entity\ProblemConditionType", inversedBy="problemTypes", cascade={"persist", "merge"})
