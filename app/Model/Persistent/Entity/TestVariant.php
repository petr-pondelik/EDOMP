...
class TestVariant extends BaseEntity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Model\Persistent\Entity\Test", inversedBy="testVariants", cascade={"persist", "merge"})
     * @Assert\NotBlank(
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Model\Persistent\Entity\ProblemFinalTestVariantAssociation", mappedBy="testVariant", cascade={"all"})
     * @Assert\NotBlank(
