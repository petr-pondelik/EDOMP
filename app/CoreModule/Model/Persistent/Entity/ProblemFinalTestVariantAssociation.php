...
class ProblemFinalTestVariantAssociation extends BaseEntity
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\CoreModule\Model\Persistent\Entity\ProblemFinal\ProblemFinal", inversedBy="testVariantAssociations", cascade={"persist", "merge"})
     * @Assert\NotBlank(
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\CoreModule\Model\Persistent\Entity\ProblemTemplate\ProblemTemplate")
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\CoreModule\Model\Persistent\Entity\TestVariant", inversedBy="problemFinalAssociations", cascade={"persist", "merge"})
     * @Assert\NotBlank(
